...
import matplotlib
#matplotlib.use(' Agg')  # Specify a backend, such as 'TkAgg', 'Qt5Agg', etc.
...
# import the street dataset - choose or adapt file path
# 1959, uncut and cut
#streets = gpd.read_file("C:/A_Noémie/Studium/HS23/Network Science/pythonProject/data/Processed_data-20240222T124742Z-001/Processed_data/Roads_AOI_1959_MLS.shp")
#streets = gpd.read_file("C:/A_Noémie/Studium/HS23/Network Science/pythonProject/data/Processed_data-20240222T124742Z-001/Processed_data/Roads_AOI_1959_MLS_cut100y_0.3.shp")
# Nowadays, uncut and cut
#streets = gpd.read_file("C:/A_Noémie/Studium/HS23/Network Science/GIS/MVollmer/Processed_data/Roads_AOI_NaD_cut100y_0.3.shp")
streets = gpd.read_file("C:/A_Noémie/Studium/HS23/Network Science/GIS/MVollmer/Processed_data/Roads_AOI_NaD.shp")
len(streets)
...
#betweenness: calculated for both nodes and edges
...
ax.set_axis_off()
ax.set_title('Betweenness Centrality node based')
plt.show()
...
#straightness (ratio between real and Euclidean distance while waking from each node to every other)
